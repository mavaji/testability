...
/**
 * The <code>AND</code> logic gate.
 *
 * @author Vahid Mavaji
 * @version 1.0 2004
 */
public class AND extends AbstractLogicGate {
    public AND(LogicGateItem logicGateItem) {
        super(logicGateItem);
        type = __and;
    }
